...
import { EmptyStateStudent } from "./components/empty-state/EmptyStateStudent";
import { ListStudents } from "./components/list-students/ListStudets";
import { ToolBar } from "./components/ToolBar";

const listStudents = null
//  [
  ...
  return (
    <LayoutWeb titlePage="Alunos">
      <div className="flex flex-col gap-4 h-full">
        <ToolBar />
        {listStudents ? <ListStudents students={listStudents} /> : <EmptyStateStudent />}
      </div>
    </LayoutWeb>
  );
}
