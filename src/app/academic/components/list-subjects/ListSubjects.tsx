  ...
  return (
    <section className="rounded-xl bg-gray-50 shadow-md flex flex-col max-h-[395px] h-full">
      ...
      <ul className=" overflow-y-auto h-full">
        {subjects.map(subject => <li key={subject.id} className="flex items-center gap-4 justify-between text-[#303972] font-semibold text-sm hover:bg-[#C1BBEB] hover:bg-opacity-20 px-4 last:rounded-b-xl ">
          {subject.name}
