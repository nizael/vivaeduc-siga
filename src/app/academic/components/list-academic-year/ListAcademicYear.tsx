  ...
  return (
    <section className="rounded-xl bg-gray-50 shadow-md flex flex-col max-h-[395px] h-full">
      ...
      <ul className=" overflow-y-auto h-full">
        {academicYears.map(academicYear => <li key={academicYear.id} className="flex items-center gap-4 justify-between text-[--text-primary] font-semibold text-sm hover:bg-[#C1BBEB] hover:bg-opacity-20 px-4 last:rounded-b-xl ">
          {academicYear.name}
