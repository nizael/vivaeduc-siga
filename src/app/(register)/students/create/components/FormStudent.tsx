    ...
    <form action={handleFormCation} className="flex flex-col gap-4">
      ...
      <details open className="bg-gray-50 rounded-lg flex flex-col gap-4 shadow-sm">
        ...
        <div className="grid grid-cols-4 gap-4 p-4">
          <CustomSelect position="top"  name="financialResponsible" label="Responsável financeiro *" options={[]} className="w-full" onChange={() => ({})} />
          <CustomSelect position="top"  name="degreeOfKinship_1" label="Parentesco *" options={[]} className="w-full" onChange={() => ({})} />
        </div>
        <div className="grid grid-cols-4 gap-4 p-4">
          <CustomSelect position="top" name="responsible" label="Responsável" options={[]} className="w-full" onChange={() => ({})} />
          <CustomSelect position="top" name="degreeOfKinship_2" label="Parentesco" options={[]} className="w-full" onChange={() => ({})} />
        </div>
      </details>
