  ...
  return (
    <section className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        ...
        <Link href={'/guardians/create'} className="border bg-[#4D44B5] text-gray-50 rounded-full h-[40px] px-4 flex items-center gap-1"><b className="text-2xl">+</b> Novo responsável</Link>
      </div>
    </section>
  )
}