...
export const BannerPlan = () => {
  return (
    <div className="bg-[#4D44B5] text-gray-50 p-4 rounded-t-xl rounded-l-xl relative overflow-hidden ">
      <div className="w-24 h-72 rounded-full bg-[#FB7D5B] absolute -bottom-32 right-4 z-0" />
      <div className="w-24 h-72 rounded-full bg-[#FCC43E] absolute  -bottom-20 -right-10 z-0" />
