...
export const ProfileMobile = () => {
  ...
  return (
    <div onMouseLeave={onClose} className="absolute top-0 right-2 max-[769px]:left-0 md:max-w-sm w-full md:shadow-sm  max-[769px]:h-full bg-opacity-70 z-20 flex items-center justify-center">
